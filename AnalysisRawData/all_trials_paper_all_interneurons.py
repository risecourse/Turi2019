    ...
    for learning in ['prelearning','locomotion', 'reward']:
        ...
        for case in my_list:
            ...
            for ntrial in trials:
                with open(file_load+'/pickled_sn__'+icell+'__'+case+'_'+ntrial+'.pkl', 'rb') as f:
        ...
        for case in my_list:
            if nCells>1: # this code errors out when there is one cell so not attempting figure then
                ...
                plt.clf()
                plt.close()
                print('Figures in: '+path_figs+learning+'/'+case+'_'+icell+'_heatmap.pdf')